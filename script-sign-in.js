...
const sectionsApp = document.querySelector('.sections')

const btnLogin = document.querySelector('.login__btn');
const btnLogOut = document.querySelector('.btn_sign--out')
...
const modalSignIncontainer = document.querySelector('.modal-sign-in')
...
const logOut = function(){
  containerApp.style.opacity = 1;
        sectionsApp.classList.remove('hidden');
        header.classList.remove('hidden');
        modalSignIncontainer.classList.add('modal--hidden')
}
...
btnLogin.addEventListener('click', function(e) {
  ...
  if(currentAccount?.pin === Number(inputLoginPin.value)) {
    ...
    containerApp.style.opacity = 100;
    sectionsApp.classList.add('hidden');
    header.classList.add('hidden');
    modalSignIn.classList.add('hidden');
    overlay.classList.add('hidden');
    modalSignIncontainer.classList.remove('modal--hidden')
